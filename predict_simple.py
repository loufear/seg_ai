...
from nnunet_mednext.inference.predict import predict_from_file
...
def main():
    ...
    parser.add_argument('-mp', '--model_path', help="model_path",
                        default="3d_fullres", required=False)
    ...
    parser.add_argument("-ntp","--num_threads_preprocessing", required=False, default=6, type=int, help=
    "Determines many background processes will be used for data preprocessing. Reduce this if you "
    "run into out of memory (RAM) problems. Default: 6")

    parser.add_argument("-ntns","--num_threads_nifti_save", required=False, default=2, type=int, help=
    ...
    predict_from_file(model_folder_name, input_folder, output_folder, folds, save_npz, num_threads_preprocessing,
